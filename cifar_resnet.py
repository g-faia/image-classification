...
if __name__ == "__main__":
  ...
  parser.add_argument(
    '--padded_size', type=int, default=40
    )
  parser.add_argument(
    '--cropped_size', type=str, default=32
    )
  parser.add_argument(
    '--log_dir', type=str, default='logs/cifar_resnet_with_summaries', 
    help='Summaries logs directory'
    )
  parser.add_argument(
    '--save_path', type=str,  default='models/cifar_resnet.ckpt'
    )
